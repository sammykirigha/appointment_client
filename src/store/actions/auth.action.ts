...
import {
  IAuthenticatedUserReturnedData,
  IAuthenticatedUserInputValues,
  IConfirmEmailInputValues,
  IRestPasswordInputValues,
...
export const forgotPasswordAction = createAsyncThunk(
  ...
  async (data: IForgotPassword, thunkAPI) => {
    try {
      ...
      const response = await apiPost(data);
      thunkAPI.dispatch(
        setMessageNotification(response.data.forgotUserPasssword)
      );
      return {
...
export const confirmEmailAction = createAsyncThunk(
  ...
  async (data: IConfirmEmailInputValues, thunkAPI) => {
    try {
      ...
      const response = await apiPost(data);
      thunkAPI.dispatch(
        setMessageNotification(response.data.resetUsersPassword)
      );
      return {
        message: response.data.resetUsersPassword as string,
        success: true,
